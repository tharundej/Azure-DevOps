...
const StyledTextGradient = styled(m.h1)(({ theme }) => ({
  ...textGradient(
    `300deg, ${theme.palette.primary.main} 0%, #00A76F 25%, ${theme.palette.primary.main} 50%, #00A76F 75%, ${theme.palette.primary.main} 100%`
  ),
  padding: 0,
  marginTop: 8,
  lineHeight: 1,
    ...
    >
      ...
      <Stack spacing={3} sx={{ textAlign: 'center' }}>
        ...
        <Stack spacing={2} direction="row" justifyContent="center">
          {['hrms', 'inventory', 'warehouse'].map((platform) => (
