...
{/* {filterName === "claimSearchFilter" && <ClaimSearchFilter  filterData={handleFilterOptions} searchData={handleFilterSearch} />} */}
        ...
        <Card>
          ...
          <TableContainer   component={Paper} sx={{top: 0, overflow: "unset", padding:'0px !important' ,  width: '100%',  }}>
            ...
            {/* <div style={{ height: '200px', overflowY: 'auto' }}> */}
              <Table  aria-label="sticky table" size={table.dense ? 'medium' : 'small'} sx={{ minWidth: 960,}} >
