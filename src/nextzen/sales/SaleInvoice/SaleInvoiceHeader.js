...
const SaleInvoiceHead = ({ filterSearch, filterData }) => {
  ...
  return (
    <>
      {showForm && (
        ...
        >
          <CreateSaleInvoice currentData={{}} handleClose={handleClose} />
        </Dialog>
      )}
      {/* <Grid container alignItems="center" paddingBottom="10px">
        <Grid md={4} xs={4} item>
          <Typography variant="h4">Sale Invoice Details</Typography>
        </Grid>
        <Grid md={4} xs={4} item>
          <TextField
            placeholder="Search...."
  ...
  />
      ...
      <Button
        ...
        onClick={handleTimeForm}
        startIcon={<Iconify icon="mingcute:add-line" />}
        sx={{color:'white',backgroundColor:'#3B82F6'}}>Add sales Invoice</Button>
...
export default SaleInvoiceHead;
