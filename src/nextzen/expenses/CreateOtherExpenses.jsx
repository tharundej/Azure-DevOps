...
export default function CreateOtherExpenses({ currentUser, handleClose }) {
  ...
  return (
    <div style={{ paddingTop: '20px' }}>
      <FormProvider methods={methods} onSubmit={onSubmit}>
        <DialogTitle>Add New Other Expense</DialogTitle>
        ...
        <DialogContent>
          ...
          >
            ...
            <RHFTextField name="invoice" label="Invoice No." />
