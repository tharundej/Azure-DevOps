...
const FuelHead = ({ filterSearch, filterData }) => {
  ...
  return (
    <>
      {showForm && (
        ...
        >
          <CreateFuelExpenses currentUser={{}} handleClose={handleClose} />
        </Dialog>
      )}
      <Grid container alignItems="center" paddingBottom="10px">
        <Grid md={4} xs={4} item>
          <Typography variant="h4">Fuel Expenses</Typography>
        </Grid>
        <Grid md={4} xs={4} item>
          <TextField
            placeholder="Search...."
