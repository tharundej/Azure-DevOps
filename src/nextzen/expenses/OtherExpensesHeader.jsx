...
const OtherExpensesHead = ({ filterSearch, filterData }) => {
  ...
  return (
    <>
      {showForm && (
        ...
        >
          <CreateOtherExpenses currentUser={{}} handleClose={handleClose} />
        </Dialog>
      )}
      <Grid container alignItems="center" paddingBottom="10px">
        <Grid md={4} xs={4} item>
          <Typography variant="h4">Other Expenses</Typography>
        </Grid>
        <Grid md={4} xs={4} item>
          <TextField
            placeholder="Search...."
...
export default OtherExpensesHead;
