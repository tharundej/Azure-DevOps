...
export default function MedicalPremium() {
  ...
  const type = [{ type: 'CGHS Contrubution' }, { type: 'Medical Expenditure' } ,{ type: 'Medical Insurance' }, { type: 'Preventive Health Checkup' }];
  ...
  const [formData, setFormData] = useState({
    ...
    insuredPersonName: 'Alice Doe',
    relationshipType: 'Spouse',
    payMode: 'Monthly',
    policyCitizenshipType: 'Resident',
    amountOfPremium: 500.0,
    eligibleDeduction: 'Yes',
        ...
        <Grid container spacing={2} style={{ marginTop: '1rem' }}>
          ...
          <Grid item container xs={12} spacing={2}>
            <Grid item xs={4}>
              ...
              <RHFAutocomplete
                name="type"
                label="Type"
                options={type.map((payscheduleType) => payscheduleType.type)}
                onChange={(event, selectedValue) => handleAutocompleteChange('type', selectedValue)}
              />
            </Grid>
            <Grid item xs={4}>
          ...
          <Grid item container xs={12} spacing={2}>
            <Grid item xs={4}>
              ...
              <TextField label="Insured Persion Name(S)" variant="outlined" fullWidth  name="policyNumber"
            ...
            <Grid item xs={4}>
              ...
              <RHFAutocomplete
                ...
                options={relationshipType.map((payscheduleType) => payscheduleType.type)}
                onChange={(event, selectedValue) => handleAutocompleteChange('relationshipType', selectedValue)}
              />
            </Grid>
            <Grid item xs={4}>
              ...
              <RHFAutocomplete
                ...
                options={policyCItizenshipType.map((payscheduleType) => payscheduleType.type)}
                onChange={(event, selectedValue) => handleAutocompleteChange('policyCitizenshipType', selectedValue)}
              />
            </Grid>
          </Grid>
          ...
          <Grid item container xs={12} spacing={2}>
            <Grid item xs={4}>
              <RHFAutocomplete
                name="payMode"
                label="Pay Mode"
                options={payMode.map((payscheduleType) => payscheduleType.type)}
                onChange={(event, selectedValue) => handleAutocompleteChange('payMode', selectedValue)}
              />
            </Grid>
            <Grid item xs={4}>
              {/* <Typography >Intrest Payable On Housing Loan For The Year</Typography> */}
              <TextField label="Amount Of Premium" variant="outlined" fullWidth name="policyNumber"
                value={formData.amountOfPremium}
                onChange={handleChange}/>
            </Grid>
            <Grid item xs={4}>
              {/* <Typography >Is The Property Self Occupied Or Let out?[See Notebelow]</Typography> */}
              <TextField label="Eligible Deduction" variant="outlined" fullWidth  name="policyNumber"
          ...
          <Grid item container xs={12} spacing={2}>
            ...
            >
              ...
              <Grid item>
                <Button className="button" onClick={editMedicalDetails}>Save</Button>
              </Grid>
              <Grid item>
