...
export default function HrITTab() {
  ...
  const TABLE_HEAD = [
    ...
    { id: 'declaration', label: 'Declaration', width: 220, type: 'text' },
    { id: 'rentdetails', label: 'Rent Details', width: 220, type: 'text' },
    { id: 'licDetails', label: 'Lic Details', width: 220, type: 'text' },
    { id: 'housingProperty', label: 'Housing Property', width: 220, type: 'text' },
    { id: 'medicalInsurance', label: 'Medical Insurance', width: 220, type: 'text' },
    { id: 'status', label: 'Status', width: 220, type: 'text' },
    // { id: '', width: 88 },
  ];
