    ...
    <>
      <Grid container alignItems="center" paddingBottom="10px">
        ...
        <Grid md={2} xs={2} sx={{ alignSelf: 'center', textAlign: 'center' }}>
          {addButton && (
            <Button variant="contained" sx={{ borderRadius: '4px' }} onClick={buttonFunction}>
              {addButton}
            </Button>
          )}
        </Grid>
            ...
            {badgeContent === true ? (
              ...
              >
                <Button
                  ...
                  style={{ width: '80px' }}
                  sx={{ animation: isBlinking ? `${blinkAnimation} 2s infinite` : '' }}
                >
      ...
      <Dialog open={open} onClose={onClose} maxWidth="1200px">
        ...
        <DialogContent>
          ...
          <Grid container justifyContent="flex-end" marginBottom={3} spacing={1}>
            ...
            <Button variant="outlined" sx={{ margin: '2px' }} onClick={handleApply}>
              apply
            </Button>
            {/* </Badge> */}
          </Grid>
