...
export default function DesignationConfig() {
  const TABLE_HEAD = [
  ...
  return (
    <>
      {/* {showForm && (
        ...
        >
          <AddDesignationConfig currentUser={{}} handleCloseAddRoleDilog={handleCloseAddRoleDilog} openAddRoleConfig={openAddRoleConfig} />
        </Dialog>
      )} */}
      <Dialog
        fullWidth
          ...
          <DialogContent>
            ...
            >
              ...
              <TextField
                ...
                onChange={(e, newValue) =>
                  handleSelectChange('department', newValue, e || null)
                }
                variant="outlined"
                fullWidth
              />
              ...
              <TextField
                ...
                onChange={(e, newValue) =>
                  handleSelectChange('designation', newValue , e|| null)
                }
                variant="outlined"
                fullWidth
              />
              ...
              <TextField
                ...
                value={valueSelected?.designationGradeName || null}
                 onChange={(e, newValue) =>
                  handleSelectChange('designationGrade', newValue ,e|| null)
                }
                variant="outlined"
                fullWidth
              />
