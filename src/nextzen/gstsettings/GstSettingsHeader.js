...
const GstSettingsHead = ({ filterSearch, filterData, getTableData }) => {
  ...
  return (
    <>
      {showForm && (
        ...
        >
          <CreateGstSettings currentData={{}} handleClose={handleClose} getTableData={getTableData} />
        </Dialog>
      )}
  ...
  />
      ...
      <Button
        ...
        onClick={handleTimeForm}
        startIcon={<Iconify icon="mingcute:add-line" />}
        sx={{color:'white',backgroundColor:'#3B82F6'}}>Add GST Settings</Button>
...
export default GstSettingsHead;
