                  ...
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DemoContainer components={['DatePicker']}>
                      <DatePicker
                        sx={{ width: '100%', paddingLeft: '3px' }}
                        label="From Date"
                        value={dates?.dueDatefrom ? dayjs(dates.dueDatefrom) : null}
                        defaultValue={dayjs(new Date())}
                        onChange={(newValue) => {
                          setDates((prev) => ({
                            ...prev,
                            dueDatefrom: newValue ? formatDateToYYYYMMDD(newValue) : '',
                          }));
                        }}
                      />
                    </DemoContainer>
...
export default PurchaseInvoiceHead;
